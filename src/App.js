...
const App = () => {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen relative flex top-[120px] border border-[#1010181f]  transition-all ease-in-out duration-300 lg:duration-500  ${isInView == true ? 'bg-[#2d46b9] text-white' : 'bg-white text-black rounded-t-3xl' }`}>
      ...
      <div className={`grid grid-cols-1 w-full min-h-screen absolute rounded-t-3xl justify-center transition-all ease-in-out duration-300 lg:duration-500 ${isInView == true ? 'bg-[#2d46b9] border-white text-white' : 'bg-white border-[#1010181f] text-black' }`}>
        ...
        <div className={`grid grid-cols-1 w-full justify-center min-h-screen transition-all ease-in-out duration-300 lg:duration-500  ${isInView == true ? 'bg-[#2d46b9] text-white' : 'bg-white text-black'}`}>
        ...
        <div className={`grid grid-cols-1 w-full justify-center text-black min-h-screen transition-all ease-in-out duration-300 lg:duration-500 ${isPinkInView == true ? 'bg-[#ffcdd2]' : 'bg-white' }`}>
